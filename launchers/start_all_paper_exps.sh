...
sbatch launchers/train_cleanrl_roger_long_long scripts/cleanrl_dqn.py griddly-ButterfliesEnvLarge smin bernoulli 1 --scale-by-std=1 --soft_reset=0 --track --total-timesteps=10_000_000
sbatch launchers/train_cleanrl_roger_long_long scripts/cleanrl_dqn.py griddly-ButterfliesEnvLarge smin bernoulli 2 --scale-by-std=1 --soft_reset=0 --track --total-timesteps=10_000_000
sbatch launchers/train_cleanrl_roger_long_long scripts/cleanrl_dqn.py griddly-ButterfliesEnvLarge smin bernoulli 3 --scale-by-std=1 --soft_reset=0 --track --total-timesteps=10_000_000
