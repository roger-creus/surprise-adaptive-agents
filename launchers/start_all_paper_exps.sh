...
# MazeEnvLarge2
sbatch launchers/train_cleanrl_roger_long scripts/cleanrl_dqn.py griddly-MazeEnvLarge2 none bernoulli 4 --scale-by-std=0 --soft_reset=0 --track --exploration-fraction=0.1 --total-timesteps=10000000
sbatch launchers/train_cleanrl_roger_long scripts/cleanrl_dqn.py griddly-MazeEnvLarge2 none bernoulli 5 --scale-by-std=0 --soft_reset=0 --track --exploration-fraction=0.1 --total-timesteps=10000000
...
sbatch launchers/train_cleanrl_roger_long scripts/cleanrl_dqn.py griddly-MazeEnvLarge2 smin bernoulli 4 --scale-by-std=1 --soft_reset=0 --track --exploration-fraction=0.1 --total-timesteps=10000000
sbatch launchers/train_cleanrl_roger_long scripts/cleanrl_dqn.py griddly-MazeEnvLarge2 smin bernoulli 5 --scale-by-std=1 --soft_reset=0 --track --exploration-fraction=0.1 --total-timesteps=10000000
...
sbatch launchers/train_cleanrl_roger_long scripts/cleanrl_dqn.py griddly-MazeEnvLarge2 smax bernoulli 4 --scale-by-std=1 --soft_reset=0 --track --exploration-fraction=0.1 --total-timesteps=10000000
sbatch launchers/train_cleanrl_roger_long scripts/cleanrl_dqn.py griddly-MazeEnvLarge2 smax bernoulli 5 --scale-by-std=1 --soft_reset=0 --track --exploration-fraction=0.1 --total-timesteps=10000000
