...
sbatch launchers/train_cleanrl scripts/cleanrl_ppo.py MinAtar/Breakout smin bernoulli 1
sbatch launchers/train_cleanrl scripts/cleanrl_ppo.py MinAtar/Breakout smax bernoulli 1
sbatch launchers/train_cleanrl scripts/cleanrl_ppo.py MinAtar/Breakout sadapt bernoulli 1
sbatch launchers/train_cleanrl scripts/cleanrl_ppo.py MinAtar/Breakout sadapt-inverse bernoulli 1
sbatch launchers/train_cleanrl scripts/cleanrl_ppo.py MinAtar/Breakout none bernoulli 1

sbatch launchers/train_cleanrl scripts/cleanrl_ppo.py MinAtar/Seaquest smin bernoulli 1
sbatch launchers/train_cleanrl scripts/cleanrl_ppo.py MinAtar/Seaquest smax bernoulli 1
sbatch launchers/train_cleanrl scripts/cleanrl_ppo.py MinAtar/Seaquest sadapt bernoulli 1
sbatch launchers/train_cleanrl scripts/cleanrl_ppo.py MinAtar/Seaquest sadapt-inverse bernoulli 1
sbatch launchers/train_cleanrl scripts/cleanrl_ppo.py MinAtar/Seaquest none bernoulli 1