...
sbatch launchers/train_cleanrl scripts/cleanrl_ppo.py SurpriseAdaptRooms-v0 sadapt gaussian 1
sbatch launchers/train_cleanrl scripts/cleanrl_ppo.py SurpriseAdaptRooms-v0 sadapt-inverse gaussian 1
sbatch launchers/train_cleanrl scripts/cleanrl_ppo.py SurpriseAdaptRooms-v0 none gaussian 1

sbatch launchers/train_cleanrl scripts/cleanrl_ppo.py SurpriseAdaptRooms-v0 smin gaussian 1 --noisy-room=1
sbatch launchers/train_cleanrl scripts/cleanrl_ppo.py SurpriseAdaptRooms-v0 smax gaussian 1 --noisy-room=1
sbatch launchers/train_cleanrl scripts/cleanrl_ppo.py SurpriseAdaptRooms-v0 sadapt gaussian 1 --noisy-room=1
sbatch launchers/train_cleanrl scripts/cleanrl_ppo.py SurpriseAdaptRooms-v0 sadapt-inverse gaussian 1 --noisy-room=1
sbatch launchers/train_cleanrl scripts/cleanrl_ppo.py SurpriseAdaptRooms-v0 none gaussian 1 --noisy-room=1