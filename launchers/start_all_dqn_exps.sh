...
sbatch launchers/train_cleanrl scripts/cleanrl_dqn.py crafter smin gaussian 8943 --track --soft_reset=1 --theta_size="(9,9)" --wandb-project-name="Crafter_DQN_test" --scale-by-std=0 --obs_size="(64,64)"