...
# # Tetris S-min
sbatch launchers/train_cleanrl scripts/cleanrl_dqn.py tetris smin bernoulli 1 --track=True --wandb-project-name="Tetris_DQN" --capture-video --scale-by-std=1 --soft_reset=0
