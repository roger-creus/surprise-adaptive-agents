...
sbatch launchers/train_cleanrl cleanrl_dqn.py --env-id=crafter --model=smin --buffer-type=gaussian --seed=8943 --track=True --soft_reset=1 --theta_size="(9,9)" --wandb-project-name="Crafter_DQN_test" --scale-by-std=0 --obs_size="(64,64)"