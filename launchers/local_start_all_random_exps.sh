...
# MinAtar/Breakout
#python scripts/random_agent.py --env-id=MinAtar/Breakout --model=none --buffer-type=bernoulli --seed=1 --scale-by-std=0 --soft_reset=1 --total-timesteps=10_000 --buffer-size=100 &
#python scripts/random_agent.py --env-id=MinAtar/Breakout --model=none --buffer-type=bernoulli --seed=2 --scale-by-std=0 --soft_reset=1 --total-timesteps=10_000 --buffer-size=100 &
#python scripts/random_agent.py --env-id=MinAtar/Breakout --model=none --buffer-type=bernoulli --seed=3 --scale-by-std=0 --soft_reset=1 --total-timesteps=10_000 --buffer-size=100
#wait
...
# MinAtar/Freeway
#python scripts/random_agent.py --env-id=MinAtar/Freeway --model=none --buffer-type=bernoulli --seed=1 --scale-by-std=0 --soft_reset=0 --total-timesteps=10_000 --buffer-size=100 &
#python scripts/random_agent.py --env-id=MinAtar/Freeway --model=none --buffer-type=bernoulli --seed=2 --scale-by-std=0 --soft_reset=0 --total-timesteps=10_000 --buffer-size=100 &
#python scripts/random_agent.py --env-id=MinAtar/Freeway --model=none --buffer-type=bernoulli --seed=3 --scale-by-std=0 --soft_reset=0 --total-timesteps=10_000 --buffer-size=100
#wait

# MinAtar/Seaquest
#python scripts/random_agent.py --env-id=MinAtar/Seaquest --model=none --buffer-type=bernoulli --seed=1 --scale-by-std=0 --soft_reset=0 --total-timesteps=10_000 --buffer-size=100 &
#python scripts/random_agent.py --env-id=MinAtar/Seaquest --model=none --buffer-type=bernoulli --seed=2 --scale-by-std=0 --soft_reset=0 --total-timesteps=10_000 --buffer-size=100 &
#python scripts/random_agent.py --env-id=MinAtar/Seaquest --model=none --buffer-type=bernoulli --seed=3 --scale-by-std=0 --soft_reset=0 --total-timesteps=10_000 --buffer-size=100
#wait
