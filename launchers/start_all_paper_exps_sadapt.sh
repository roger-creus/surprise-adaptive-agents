...
# MazeEnvLarge2
sbatch launchers/train_cleanrl_roger_long scripts/cleanrl_dqn.py griddly-MazeEnvLarge2 sadapt-bandit bernoulli 1 --scale-by-std=0 --soft_reset=0 --track --exploration-fraction=0.1 --total-timesteps=10_000_000 --use_surprise=False --ucb_coeff=0.02
sbatch launchers/train_cleanrl_roger_long scripts/cleanrl_dqn.py griddly-MazeEnvLarge2 sadapt-bandit bernoulli 2 --scale-by-std=0 --soft_reset=0 --track --exploration-fraction=0.1 --total-timesteps=10_000_000 --use_surprise=False --ucb_coeff=0.02
sbatch launchers/train_cleanrl_roger_long scripts/cleanrl_dqn.py griddly-MazeEnvLarge2 sadapt-bandit bernoulli 3 --scale-by-std=0 --soft_reset=0 --track --exploration-fraction=0.1 --total-timesteps=10_000_000 --use_surprise=False --ucb_coeff=0.02

# Maze2
sbatch launchers/train_cleanrl_roger_long scripts/cleanrl_dqn.py griddly-MazeEnv2 sadapt-bandit bernoulli 1 --scale-by-std=0 --soft_reset=0 --track --learning-starts=10000 --exploration-fraction=0.2 --ucb_coeff=0.01 --use_surprise=False
sbatch launchers/train_cleanrl_roger_long scripts/cleanrl_dqn.py griddly-MazeEnv2 sadapt-bandit bernoulli 2 --scale-by-std=0 --soft_reset=0 --track --learning-starts=10000 --exploration-fraction=0.2 --ucb_coeff=0.01 --use_surprise=False
sbatch launchers/train_cleanrl_roger_long scripts/cleanrl_dqn.py griddly-MazeEnv2 sadapt-bandit bernoulli 3 --scale-by-std=0 --soft_reset=0 --track --learning-starts=10000 --exploration-fraction=0.2 --ucb_coeff=0.01 --use_surprise=False

# # ButterfliesEnvLarge2
sbatch launchers/train_cleanrl_roger_long scripts/cleanrl_dqn.py griddly-ButterfliesEnvLarge2 sadapt-bandit bernoulli 1 --scale-by-std=0 --soft_reset=0 --track --total-timesteps=15_000_000 --exploration-fraction=0.5 --use_surprise=False
sbatch launchers/train_cleanrl_roger_long scripts/cleanrl_dqn.py griddly-ButterfliesEnvLarge2 sadapt-bandit bernoulli 2 --scale-by-std=0 --soft_reset=0 --track --total-timesteps=15_000_000 --exploration-fraction=0.5 --use_surprise=False
sbatch launchers/train_cleanrl_roger_long scripts/cleanrl_dqn.py griddly-ButterfliesEnvLarge2 sadapt-bandit bernoulli 3 --scale-by-std=0 --soft_reset=0 --track --total-timesteps=15_000_000 --exploration-fraction=0.5 --use_surprise=False
