...
python3 scripts/dqn_smirl.py --config=configs/tetris_SMiRL.json --run_mode=local --exp_name=SMin_final --training_processor_type=cpu --log_comet=true --random_seeds=3 --meta_sim_threads=3
