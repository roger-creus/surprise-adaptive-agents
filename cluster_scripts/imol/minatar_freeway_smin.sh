...
python3 scripts/dqn_smirl.py --config=configs/imol/MinAtar_SMin.json --run_mode=local --exp_name=SMin --training_processor_type=gpu --log_comet=true --random_seeds=3 --meta_sim_threads=3 --env=MinAtar/Freeway-v0
