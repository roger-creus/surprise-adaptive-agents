...
python3 scripts/dqn_smirl.py --config=configs/imol/tetris_SMin.json --run_mode=local --exp_name=SMin_imol --training_processor_type=gpu --log_comet=true --random_seeds=3 --meta_sim_threads=3
