...
python3 scripts/dqn_smirl.py --config=configs/MinAtar_DQN.json --run_mode=local --exp_name=DQN --training_processor_type=gpu --log_comet=true --random_seeds=3 --meta_sim_threads=3 --env=MinAtar/Asterix-v0
