...
python3 scripts/dqn_smirl.py --config=configs/imol/MinAtar_SABandit.json --run_mode=local --exp_name=SABandit --training_processor_type=gpu --log_comet=true --random_seeds=3 --meta_sim_threads=3 --env=MinAtar/SpaceInvaders-v0
