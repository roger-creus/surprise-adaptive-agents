...
sbatch cluster_scripts/crafter/train_cpu scripts/dqn_smirl.py --config=configs/crafter/Random_agent_mlp_no_softreset.json --run_mode=local --exp_name=random_mlp_no_softreset --training_processor_type=gpu --log_comet=true