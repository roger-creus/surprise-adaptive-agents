...
# Sadapt
sbatch cluster_scripts/crafter/train scripts/dqn_smirl.py --config=configs/crafter/crafter_SA_large_replay_buffer_online.json --run_mode=local --exp_name=crafter_sa_short_new_thresh_larger_replay_eps_greedy_online3  --training_processor_type=gpu --log_comet=true
