...
# Sadapt
sbatch cluster_scripts/crafter/train scripts/dqn_smirl.py --config=configs/crafter/crafter_SA_large_replay_buffer_online.json --run_mode=local --exp_name=crafter_sa_short_new_thresh_larger_replay_eps_greedy_online2_repeated  --training_processor_type=gpu --log_comet=true
...
# Smax
# sbatch cluster_scripts/crafter/train scripts/dqn_smirl.py --config=configs/crafter/crafter_SMAX_large_replay_buffer_online.json --run_mode=local --exp_name=crafter_smax_short_larger_replay_eps_greedy_online  --training_processor_type=gpu --log_comet=true
